...
export const projects: Project[] = [
  ...
  {
    id: "roblox-ai-system",
    title: "Corruption Co. Horror AI",
    category: "Roblox / Horror Game AI",
    description: "Freelance NPC systems for a Roblox horror game, built around reactive pursuit, asymmetric player perception, item interaction, and deceptive transformation mechanics.",
    ...
    detailedDescription: {
      ...
      highlights: [
        "Lime tracks nearby players, changes between approach, retreat, flee, and attack states, and reacts to thrown objects",
        "Captured players are hidden inside map walls and can escape through a repeated wall-banging interaction",
        "Baby Purple advances outside a player's gaze, steals and uses held items, and retreats when players fight back",
        "The Returned secretly changes one player while showing teammates as physics-driven collectible orbs only on that player's client",
        "Separated the transformed player's normal self-perception from the appearance and behavior seen by other players",
        "Diagnosed proximity and spawn lag as an asset-complexity problem rather than an AI-script problem",
      ],
    },
  },
];
