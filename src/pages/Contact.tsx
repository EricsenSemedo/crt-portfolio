  ...
  return (
    <div className="crt-page bg-page-tint h-full w-full overflow-y-auto text-crt-text">
      <div className="bg-page-tint min-h-full px-6 py-8">
        ...
        <section className="mx-auto mt-12 max-w-4xl border-y border-crt-border-secondary">
          <div className="grid grid-cols-1 md:grid-cols-2 [&>a]:border-x-0 [&>a]:border-b-0 [&>a]:border-t-0 [&>a+*]:border-t [&>a+*]:border-crt-border-secondary md:[&>a+*]:border-l md:[&>a+*]:border-t-0">
            ...
            <CRTActionLink href="https://github.com/EricsenSemedo" label="GitHub" description="Projects, code & contributions" icon={
              <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
