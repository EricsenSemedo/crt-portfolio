          ...
          <div className="max-w-md mx-auto space-y-4">
            ...
            >
              <div className="flex-shrink-0">
                <svg className="w-8 h-8 text-crt-info group-hover:text-crt-info-hover transition-colors" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="flex-shrink-0">
                <svg className="w-5 h-5 text-crt-text-tertiary group-hover:text-crt-info-hover transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            >
              <div className="flex-shrink-0">
                <svg className="w-8 h-8 text-crt-secondary group-hover:text-crt-secondary-hover transition-colors" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="flex-shrink-0">
                <svg className="w-5 h-5 text-crt-text-tertiary group-hover:text-crt-secondary-hover transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                </svg>
              </div>
            </a>
