    ...
    <div className="w-full h-full overflow-y-auto bg-crt-base text-crt-text">
      <div className="min-h-full px-6 py-8 space-y-8">
        ...
        <section className="text-center space-y-4 pt-8">
          <h1 className="text-4xl md:text-5xl font-display font-bold bg-gradient-to-r from-crt-gradient-from to-crt-gradient-to bg-clip-text text-transparent tracking-wide">
            Let's Connect
          </h1>
