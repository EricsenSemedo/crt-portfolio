...
export default function CRTActionLink({ href, label, description, icon, primary = false }: CRTActionLinkProps) {
  ...
  return (
    <a href={href} target="_blank" rel="noopener noreferrer"
      ...
      <svg className={"relative z-10 h-5 w-5 shrink-0 transition-colors " + (fill.fillVisible ? "text-[#111]" : "text-crt-text-tertiary")} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
