  ...
  beforeEach(() => {
    ...
    vi.stubGlobal("matchMedia", vi.fn((query: string): MediaQueryList => {
      ...
      return {
        ...
        media: query,
        onchange: null,
        addEventListener: (_event: string, listener: EventListenerOrEventListenerObject | null) => listeners.add(listener as () => void),
        removeEventListener: (_event: string, listener: EventListenerOrEventListenerObject | null) => listeners.delete(listener as () => void),
        addListener: vi.fn(),
