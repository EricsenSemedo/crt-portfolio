...
- [Desktop recording](./hash-navigation-desktop.mp4): open Profile; browser Back returns to the TV overview; Forward restores Profile; navigate to Projects and open PullWorth; Back closes the project; Forward reopens it; reload the project URL; close to the gallery. The first navigation sequence is at 0–8 seconds; project Back/Forward and reload begin around 30 seconds; in-page close is near the end.
