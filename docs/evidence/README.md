...
Automated coverage: route selection and redirects; duplicate-entry prevention; direct-link close fallback; Back/Forward through views and projects; retaining the scene; ignoring superseded focus callbacks; acknowledging a TV already focused by a local selection. Lint, all 82 tests, and the type-checked production build passed.
